<header class="main">
    <a href="javascript:;" data-menu-status="true" class="menu_switch opened"><i class="fa fa-bars"></i></a>
    <h1><?= $text_dashboard ?>
        <?php if (isset($title)): ?>
            <?= ' > ' . $title ?>
        <?php endif; ?>
    ...
    <a href="/language" class="language_switch"><span><?= $_SESSION['lang'] == 'ar' ? 'eng' : 'عربي' ?></span> <i class="fa fa-globe"></i></a>
</header>